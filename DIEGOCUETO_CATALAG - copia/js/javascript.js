function guardar(){
 ...
 function tabla (MartilloSencillo, img, $300){
   ...
   var st = 300;
    ...
    nuevatabla = new tabla("MartilloSencillo", "img", "$300");
...
function agregar(){
    ...
    document.getElementById("tab").innerHTML += '<tbody><td>'+nuevatabla.img+'</td><td>'+nuevatabla.MartilloSencillo+'</td></td><td>'+nuevatabla+'</td> <td>'+nuevatabla.$300+'</td></tbody>';
...
function agregar1(){
    ...
    document.getElementById("tab1").innerHTML += '<tbody><td>'+nuevatabla1.img2+'</td><td>'+nuevatabla1.Martillo+'</td> <td>'+nuevatabla1.cantidad+'</td> <td>'+nuevatabla1.$200+'</td></tbody>';
};
...
function agregar2(){
    ...
    document.getElementById("tab2").innerHTML += '<tbody><td>'+nuevatabla2.img3+'</td><td>'+nuevatabla2.Martillo_acero+'</td> <td>'+nuevatabla2.cantidad+'</td> <td>'+nuevatabla2.$250+'</td></tbody>';
};
...
function agregar3 (){
    ...
    document.getElementById("tab3").innerHTML += '<tbody><td>'+nuevatabla3.img4+'</td><td>'+nuevatabla3.Motosierra_staley+'</td> <td>'+nuevatabla3.cantidad+'</td> <td>'+nuevatabla3.$400+'</td></tbody>';
};
...
function agregar4(){
    ...
    document.getElementById("tab4").innerHTML += '<tbody><td>'+nuevatabla4.img5+'</td><td>'+nuevatabla4.Garden_machete+'</td> <td>'+nuevatabla4.cantidad+'</td> <td>'+nuevatabla4.$100+'</td></tbody>';
...
function guardar5(){
    ...
    function agregar5(){
      ...
      document.getElementById("tab5").innerHTML += '<tbody><td>'+nuevatabla5.img6+'</td><td>'+nuevatabla5.Motosierra_de_gasolina_poda+'</td> <td>'+nuevatabla5.cantidad+'</td> <td>'+nuevatabla5.$500+'</td></tbody>';
    ...
    function agregar6 (){
        ...
        document.getElementById("tab5").innerHTML += '<tbody><td>'+nuevatabla6.img7+'</td><td>'+nuevatabla6.Motosierra_STIHL+'</td> <td>'+nuevatabla6.cantidad+'</td> <td>'+nuevatabla6.$300+'</td></tbody>';
    };
  ...
  function guardar7(){
    ...
    function agregar7 (){
        ...
        document.getElementById("tab6").innerHTML += '<tbody><td>'+nuevatabla7.img8+'</td><td>'+nuevatabla7.pala_coa_mangoDeMadera+'</td> <td>'+nuevatabla7.cantidad+'</td> <td>'+nuevatabla7.$300+'</td></tbody>';
    };
    ...
    function agregar8 (){
        ...
        document.getElementById("tab7").innerHTML += '<tbody><td>'+nuevatabla8.img9+'</td><td>'+nuevatabla8.Serrucho_de_poda_plegable+'</td> <td>'+nuevatabla8.cantidad+'</td> <td>'+nuevatabla.$300+'</td></tbody>';
    };
    ...
    function agregar9 (){
        ...
        document.getElementById("tab8").innerHTML += '<tbody><td>'+nuevatabla9.img10+'</td><td>'+nuevatabla9.Tramontina_machete+'</td> <td>'+nuevatabla.cantidad+'</td> <td>'+nuevatabla.$300+'</td></tbody>';
